...
create table event_photos (                 -- past-event social proof
  id uuid primary key default gen_random_uuid(),
...
create table arrival_help_requests (
  id uuid primary key default gen_random_uuid(),
...
create table arrival_help_offers (
  id uuid primary key default gen_random_uuid(),
...
create table voter_relay_messages (
  id uuid primary key default gen_random_uuid(),
